<footer class="footer">
    ...
    <div class="footer-copyright">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 precopyright">
                    <span class="copyright ">© 2017 Tous droits réservés - Made with
                        <i class="fa fa-heart" style="color:#ef182a;" aria-hidden="true"></i> by TechDeals Developers</span>
                </div>
