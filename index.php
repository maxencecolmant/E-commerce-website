...
<main id="main" class="container main">
 ...
 FROM products LEFT JOIN category_ ON products.id_category = category_.id_category WHERE is_hidden = :v ORDER BY id_product DESC LIMIT 4',
    [ ':v' => 1, ]
                    ...
                    <div class="product-item-4">
                        <div class="product">
                            <div class="content">
                                <img class="img-responsive" src="/assets/images/products/<?php echo $pr['img_product']; ?>" alt="">
                                <span class="cat">
                                    <?php echo $pr['name_category']; ?>
                                </span>
                                <a href="product.php?id=<?php echo $pr['id_product']; ?>" class="title">
                                    <?php echo $pr['name_product']; ?>
                                </a>
                                ...
                                <div class="price">
                                    ...
                                    <span class="currentPrice">
                                        <?php echo $pr['price_product']; ?> €
                                    </span>
                                    <span class="oldPrice"></span>
                                </div>
                                <a href="product.php?id=<?php echo $pr['id_product']; ?>" class="cart-btn">
                        ...
                        <div class="category">
                            <div class="content">
                                <div class="category-header">
                                    <a href="view.php?category=<?php echo $main; ?>" class="title">
                                        <?php echo $main; ?>
                                    </a>
                                </div>
                                <?php
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="view.php?category=<?php echo $info['name_category'];?>">
                                                <?php echo $info['name_category'];?>
                                            </a>
                                        </li>
                                        <?php endforeach; ?>
                                    </ul>
