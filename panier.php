                                        ...
                                        <tr>
                                            <form method="post" action="panier.php">
                                                <td class="align-middle text-center">
                                                    <a href="">
                                                        <img class="img-responsive center-block extra-small-img" alt="product" src="<?php echo $curr_product['img_product']; ?>">
                                                    </a>
                                                </td>
                                                <td class="align-middle text-center">
                                                ...
                                                <td class="align-middle text-center">
                                                    <input type="number" class="form-control stepper-input" id="q_<?php echo $i;
                                               $i++; ?>" name="q" value="<?php echo $_SESSION['cart'][$curr_product['id_product']]['quantity_product_ordered']; ?>"
                                                        step="1">
                                                </td>
                                                <td class="align-middle text-center">
                                                ...
                                                <td class="align-middle text-center">
                                                    <input type="hidden" name="id" value="<?php echo $curr_product['id_product']; ?>">
                                                    <input type="hidden" name="action" value="refresh">
                                                    <button type="submit" class="btn btn-info text-center no-margin" href="#">
                                                        <i class="fa fa-refresh"></i>
                                                    </button>
                                                    <button id="<?php echo $curr_product['id_product']; ?>" class="btn btn-danger text-center no-margin remove-product">
                                ...
                                <div class="spacer-top-5">
                                    <div class="row spacer-bottom-5">
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <?php echo $cart->cartHT(); ?> €</div>
                                    </div>
                                    <div class="row spacer-bottom-5">
                                        <div class="col-xs-6">TVA:</div>
                                        <div class="col-xs-6 text-right">
                                            <?php echo $cart->cartTVA(); ?> €</div>
                                    </div>
                                    <div class="row"></div>
                                    <div class="row spacer-bottom-5">
                                        <div class="col-xs-6 ">
